...
describe Transfermarkt::Team do
  ...
  let(:national_response) do
    england = transfermarkt_file('england')
  ...
  let(:club_response) do
    liverpool = transfermarkt_file('liverpool')
  ...
  describe "#name" do
    context 'England' do
      it "returns England" do
        expect(national_response.name).to eq("England")
      end
    end
    context 'Liverpool FC' do
      it "returns Liverpool FC" do
        expect(club_response.name).to eq("Liverpool FC")
      end
    end
  end
