...
describe Transfermarkt::Player do
  ...
  describe "#full_name" do
    it "returns the player's full name" do
      expect(player.full_name).to eq("Daniel Sturridge")
    end
  end

  describe "#full_name" do
    it "returns the player's full name" do
      expect(player.squad_number).to eq("15")
    end
  end
  ...
  describe "#height" do
    it "returns the player's height" do
      expect(player.height).to eq(183)
    end
  end
  ...
  describe "#transfer_history" do
    ...
    it "returns the cost of transfer" do
      expect(player.transfer_history[0]['cost']).to eq(15_000_000)
    end
  end
end
